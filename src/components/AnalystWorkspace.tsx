...
Automated notification generated by eGRC Waterfall Management Portal.`;
  ...
  return (
    <div id="analyst-workspace" className="space-y-5 animate-in fade-in duration-200">
      ...
      {/* Top Header Card with Clean 3-Tab Navigation & Actions */}
      <div className="bg-white rounded-2xl border border-stone-200 p-4 sm:p-5 shadow-xs">
        ...
        {/* 3 Clean Tabs: Waterfall Requirements Table, Complete Analytics, Finalise & Submit */}
        <div className="flex border-b border-stone-200 text-xs font-semibold overflow-x-auto">
